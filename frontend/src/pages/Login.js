...
function Login() {
    ...
    const navigate =useNavigate()
     const {fatchUserDetails,fetchUserAddToCart} = useContext(Context)
            ...
            <div className='bg-white p-5 w-full max-w-sm mx-auto'>
                  ...
                  <form className='pt-6 flex flex-col gap-2' onSubmit={handleSubmit} >
                    ...
                    <div>
                        ...
                        <Link to={'/forgot-password'} className='block w-fit ml-auto hover:un hover:text-red-600'>
                           Forgot password ?
                        </Link>
                ...
                <p className='my-5'>Don't have account ? <Link to={"/sign-up"} className=' text-red-600 hover:text-red-700 hover:underline'>Signup</Link></p>
