    ...
    <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
      ...
      <div className='h-96 flex flex-col lg:flex-row-reverse gap-4 relative'>
        <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2'>
          <img src={activeImage} className='h-full w-full object-scale-down mix-blend-multiply' onMouseMove={handleZoomImage} onMouseEnter={handleZoomImage} onMouseLeave={handleLeaveImageZoom} />
          {/*product zoom */}
          {
            zoomImage &&(
              <div className='hidden lg:block absolute right-[-410px] top-0 min-w-[400px] min-h-[400px] bg-slate-200 p-1'>
              <div className='w-full h-full min-h-[400px] min-w-[400px] bg-slate-200 mix-blend-multiply'
                 style={{
                  backgroundImage: `url(${activeImage})`,
                  backgroundRepeat: 'no-repeat',
                  backgroundPosition: `${zoomImageCoordinate.x * 100}% ${zoomImageCoordinate.y * 100}%`,
                  backgroundSize: '200%', // This will zoom in on the image
                }}>
                    </div>
                  </div>
          ...
          {/*product details*/ }
          {
            loading ?(
              ...
              <p className='bg-slate-200 text-red-600 px-2  w-fit rounded-full inline-block '>{data?.brandName}</p>
